...
//two state linker model for vinculin (Huang et al. 2017)

//Talin approx.
/*const double k10o = 0.193336047;
const double x10 = 0.0;
const double k20o = 5.5E-3;
const double x20 = 1.2;
const double k12o = 6.1;
const double x12 = 0.4;
const double k21o = 43;
const double x21 = -3.4;*/

// new Talin approx., org Owen
/*const double k10o = 24.0;
const double x10 = 0.0;
const double k20o = 2.20E-04;
const double x20 = 1.2;
const double k12o = 6.1;
const double x12 = 0.4;
const double k21o = 43;
...
// Owen and talin-like
/*const double k10o = 1.94E-1;
const double x10 = 0.0;
const double k20o = 5.5E-6;
const double x20 = 2.5;
const double k12o = 6.1;
const double x12 = 0.4;
const double k21o = 43;
const double x21 = -1.6;*/


// Owen and talin-like, higher minimum unbinding rate
/*const double k10o = 1.94E-1;
const double x10 = 0.0;
const double k20o = 1E-3;
const double x20 = 2.5;
const double k12o = 6.1;
const double x12 = 0.4;
const double k21o = 43;
...
// Owen and talin-like, vary k20o
const double k10o = 1.94E-1;
const double x10 = 0.0;
const double k20o = 3E-3;
const double x20 = 2.5;
const double k12o = 6.1;
const double x12 = 0.4;
const double k21o = 43;
...
double kj_value_unbind_twostate(double bond_k, double l_zero, double curr_bond_length)
{
    double curr_force = fabs(F_bond(bond_k, l_zero, curr_bond_length));
    
    double k21 = k21o * exp(curr_force * x21 / 4.114);
    double k12 = k12o * exp(curr_force * x12 / 4.114);
    
    double P_w1 = k21 / (k12 + k21);
    double P_w2 = 1.0 - P_w1;
    
    double k10 = k10o * exp(curr_force * x10 / 4.114);
    double k20 = k20o * exp(curr_force * x20 / 4.114);
    
    double kj_value = k10*P_w1 + k20*P_w2;
    
    return kj_value;
}

double P_event_unbind_twostate(double bond_k, double l_zero, double curr_bond_length, double dt)
{
    double Rdt = kj_value_unbind_twostate(bond_k, l_zero, curr_bond_length) * dt;
...
int main(int argc, char** argv)
{
    ...
    while(step*dt*0.020*1000 < 500)
    {
        ...
        base_prob_unbind[0] = P_event_unbind_twostate(bond_k1, l_zero, equal_bond_length, dt);
        base_kj_unbind[0] = kj_value_unbind_twostate(bond_k1, l_zero, equal_bond_length);
        ...
        {    
            ...
            base_prob_unbind[uf] = P_event_unbind_twostate(bond_k1, l_zero, unfolded_integrin_bond_length[uf-1], dt);
            base_kj_unbind[uf] = kj_value_unbind_twostate(bond_k1, l_zero, unfolded_integrin_bond_length[uf-1]);
        ...
        for(int i = 0; i < n_unfoldable_domains+1; i++)
        {
            for(int j = i; j < n_unfoldable_domains+1; j++)
            {
                ...
                else
                {
                    ...
                    /*double tmp_val = unfolded_probabilities_prior[i] * nCr(n_unfoldable_domains-i, num_unfold) * pow_integer(1.0 - base_prob_unfold[i], n_unfoldable_domains-j) * pow_integer(base_prob_unfold[i], num_unfold);
                    
                    unfolded_probabilities_curr[j] += tmp_val;*/
        ...
        double curr_cos_angle = cos(atan((l_t_0*sin(PI*0.25)) / (l_t_0*cos(PI*0.25) + total_actin_distance)));
