...
class Simulation
{
	private:
        ...
        vector<double> unfolding_rate_constants = {4.2e-6, 1.7e-8, 0.018, 4.2e-6, 2.5e-5, 2.5e-5, 4.2e-6, 4.2e-6, 4.2e-6, 2.5e-5, 2.5e-5, 1.7e-8};
        vector<double> unfolding_alpha = {3.1/4.114, 3.4/4.114, 5.7/4.114, 3.1/4.114, 4.1/4.114, 4.1/4.114, 3.1/4.114, 3.1/4.114, 3.1/4.114, 4.1/4.114, 4.1/4.114, 3.4/4.114};
        ...
        bool attachedToIntegrin;
        bool attachedToActin;
        
        double talinActinBreakForce;
	...
	public:
        ...
        void writeFRCFile(std::ofstream& outputFRC);
        void writeFTAFile(std::ofstream& outputFTA);
